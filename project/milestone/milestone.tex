...
\begin{figure*}[ht]
	...
	\caption{Performance comparison of row and column oriented access pattern. On the x-axis the matrix dimension refers to the $\log_2$ of actual size of the two-dimensional matrix. }
	\label{fig:perf}
\end{figure*}
