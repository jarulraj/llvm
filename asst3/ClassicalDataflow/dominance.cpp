...
DataFlowResult computeDom(Loop* L) {
  ...
  // Domain = basic blocks. Since our data flow runs on functions, get a block in the loop, and then get its parent function. Need to convert BBs to void* for our generic implementation
